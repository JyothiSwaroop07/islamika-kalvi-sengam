...
import img1 from '../images/law (1).jpg'
import img2 from '../images/law (2).jpg'
import img3 from '../images/law (3).jpg'
...
import img10 from '../images/law (10).jpg'
import img11 from '../images/law (11).jpg'
import img12 from '../images/law (12).jpg'
import img13 from '../images/law (13).jpg'
import img14 from '../images/law (14).jpg'
import img15 from '../images/law (15).jpg'

import cordinator from './Coordinator.jpg';
import head from './Legal Adviser.jpg';
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-6 justify-center p-4 items-center">
                <h1 className="text-[#2dad5c] text-2xl font-bold">Department of Legal Activities</h1>
                ...
                <div className='card h-[350px] text-center w-[200px] shadow-md md:mx-5'>
                        ...
                        <div className='details flex flex-col gap-3 justify-center items-center p-4'>
                            <h1 className='text-lg font-bold'>Advocate Salih Hussain</h1>
                            <h1 className='text-md font-bold text-[#2dad5c]'>Legal Advisor</h1>
                        </div>
                    </div>
                    ...
                    <div className='card h-[350px] text-center w-[200px] shadow-md'>
                        ...
                        <div className='details flex flex-col gap-3 justify-center items-center p-4'>
                            <h1 className='text-lg font-bold'>Mohideen</h1>
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center items-center">
                        ...
                        File case against the govt Official who are not working properly 

                        </div>
                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        Asking details from govt officials by RTI
                        ...
                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        Providing free legal consultation for needy peoples 

                        </div>

                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        Undertaking the cases of needy peoples to get their rights
                        </div>
                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        Conducting free legalleagal camps 
