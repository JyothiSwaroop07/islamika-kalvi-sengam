...
import img7 from '../images/makthab (7).jpg';
import img8 from '../images/makthab (8).jpg';
import img9 from '../images/makthab (9).jpg';
import img10 from '../images/makthab (10).jpg';
import img11 from '../images/makthab (11).jpg';
import img12 from '../images/makthab (12).jpg';
import img13 from '../images/makthab (13).jpg';
import img14 from '../images/makthab (14).jpg';
import img15 from '../images/makthab (15).jpg';
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-6 justify-center p-4 items-center">
                <h1 className="text-[#2dad5c] text-2xl font-bold">Department of Health and Welfare Aids</h1>
                ...
                <div className='card h-[350px] text-center w-[200px] shadow-md md:mx-5'>
                        ...
                        <div className='details flex flex-col gap-3 justify-center items-center p-4'>
                            <h1 className='text-lg font-bold'>Mohammed Thowheed Jamali bin Seyed  Ibrahim</h1>
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center items-center">
                        ...
                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        Collaboration with the Hospitals for Reduction of Bills


                        </div>
                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        MOU with UNWO for Free Treatment in Some Hospital Across tamilnadu


                        </div>
                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        AIE Medical Help Scheme
                        </div>

                        <div className="flex justify-center items-center text-cemter text-black bg-white border-1.5 border-[#2dad5c] w-[200px] h-[150px] p-3 text-lg font-bold shadow-sm shadow-[#2dad5c]">
                        Provision of Monthly Medicines to Elder Peoples
