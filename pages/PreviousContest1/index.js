...
<div className="w-full max-w-4xl mx-auto mt-8">
      ...
      ></iframe>
                ...
                <div className="flex flex-col items-center text-center my-8 w-[100vw] mx-auto p-6 bg-gray-100 shadow-md rounded-md">
                    <button className="bg-[#2dad5c] w-[145px] h-[45px] mx-auto mb-3 text-white rounded-md" onClick={handleBack}>← Go Back</button>
...
export default PreviousContest1;
