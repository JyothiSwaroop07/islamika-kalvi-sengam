    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center p-5 font-serif">
            ...
            <form >
                    ...
                    {/* <h1>{form.date}</h1> */}
                    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSf2xNn9QYSz9T48Xg5WOamzlldKPHJVqFJkwQblO7qBAHJG0A/viewform?embed=true" width="900" className="w-[100vw] min-h-[1800px] max-h-[2200px]" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
