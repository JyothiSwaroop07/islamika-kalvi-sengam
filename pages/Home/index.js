  ...
  <div className="flex flex-col justif-center items-center">
    ...
    <section id="about" className="flex flex-col m-auto justify-center items-center px-10 w-[85vw]">
        ...
        <div className="w-[80vw]  my-12">
            <Image src={summercamp2Image} className="w-[100%] cursor-pointer hover:scale-105 h-[1280px] lg:h-[260px]" width={913} height={1280} alt="summercamp banner" onClick={()=>router.push("/SummerCamp")}/>
        </div>
