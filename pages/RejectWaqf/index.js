            ...
            <main style={styles.main}>
                ...
                <section style={styles.description}>
                    <p style={styles.paragraph}>
                        <span style={styles.highlight}>Save Indian Waqf Properties, Reject The Waqf Amendment Bill!</span>
                        <br /><br />
                        ...
                        <span style={styles.italic}>"If people see some evil but do not change it, soon Allah will send His punishment upon them all”</span> 
                        ...
                        <br /><br />
                        <span style={styles.bold}>Stop the evil or bear its liabilities in this life and in the Hereafter!</span> 
