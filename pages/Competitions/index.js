            ...
            <div className="container mx-auto my-6">
                ...
                <div className="space-y-4 mb-8">
                    ...
                    <div className="bg-transparent text-white p-4 rounded-md text-center flex flex-col items-center">
                        <Image src="assets/form-img-1.jpg" alt="Banner for Competition 1" className="w-100 h-auto rounded-md mb-2" />
                    ...
                    <div className="bg-transparent text-white p-4 rounded-md text-center flex flex-col items-center">
                        <Image src="assets/form-img-2.jpg" alt="Banner for Competition 2" className="w-100 h-auto rounded-md mb-2" />
                    ...
                    <div className="bg-transparent text-white p-4 rounded-md text-center flex flex-col items-center">
                        <Image src="assets/form-img-3.jpg" alt="Banner for Competition 3" className="w-100 h-auto rounded-md mb-2" />
